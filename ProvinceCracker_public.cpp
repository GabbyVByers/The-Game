...
void ProvinceCracker::BuildProvinces(sf::Image& worldMap) {
    CrackProvinces(worldMap);
    ItterateUntilFinished(worldMap);
}

void ProvinceCracker::CrackProvinces(sf::Image& worldMap) {
    State& s = GetState();
...
void ProvinceCracker::ItterateProvinceGrowth(sf::RenderWindow* window, sf::Image& worldMap) {
    State& s = GetState();
    std::vector<Province>& provinces = s.provinces;
...
void ProvinceCracker::ItterateUntilFinished(sf::Image& worldMap) {
    State& s = GetState();
    std::vector<Province>& provinces = s.provinces;
